...
extern void pg_stat_update_dead_tuples_xid(PgStat_StatTabEntry *tabentry, const PgStat_TableStatus *lstats);
extern void pg_stat_balance_dead_tuples_xid(PgStat_StatTabEntry *tabentry);
